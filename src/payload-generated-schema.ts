...
export const enum_pages_blocks_content_section_button_icon = pgEnum(
  'enum_pages_blocks_content_section_button_icon',
  ['arrow-right', 'arrow-left', 'external-link', 'download', 'none'],
)
...
export const enum__pages_v_blocks_content_section_button_icon = pgEnum(
  'enum__pages_v_blocks_content_section_button_icon',
  ['arrow-right', 'arrow-left', 'external-link', 'download', 'none'],
)
...
export const enum_haut_de_page_nav_items_sub_navigation_link_type = pgEnum(
  'enum_haut_de_page_nav_items_sub_navigation_link_type',
  ['reference', 'custom'],
)
export const enum_haut_de_page_nav_items_link_type = pgEnum(
  'enum_haut_de_page_nav_items_link_type',
  ['reference', 'custom'],
)
...
export const pages_blocks_content_section_images = pgTable(
  'pages_blocks_content_section_images',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('pages_blocks_content_section_images_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_content_section_images_parent_id_idx').on(columns._parentID),
    pages_blocks_content_section_images_image_idx: index(
      'pages_blocks_content_section_images_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages_blocks_content_section.id],
      name: 'pages_blocks_content_section_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const pages_blocks_content_section = pgTable(
  'pages_blocks_content_section',
  {
    ...
    _path: text('_path').notNull(),
    id: varchar('id').primaryKey(),
    cardInfo: jsonb('card_info'),
    badge: varchar('badge'),
    content: jsonb('content'),
    button_text: varchar('button_text'),
    button_href: varchar('button_href'),
    button_icon:
      enum_pages_blocks_content_section_button_icon('button_icon').default('arrow-right'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
    _orderIdx: index('pages_blocks_content_section_order_idx').on(columns._order),
    _parentIDIdx: index('pages_blocks_content_section_parent_id_idx').on(columns._parentID),
    _pathIdx: index('pages_blocks_content_section_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [pages.id],
      name: 'pages_blocks_content_section_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const _pages_v_blocks_content_section_images = pgTable(
  '_pages_v_blocks_content_section_images',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_content_section_images_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_content_section_images_parent_id_idx').on(
      columns._parentID,
    ),
    _pages_v_blocks_content_section_images_image_idx: index(
      '_pages_v_blocks_content_section_images_image_idx',
    ).on(columns.image),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v_blocks_content_section.id],
      name: '_pages_v_blocks_content_section_images_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const _pages_v_blocks_content_section = pgTable(
  '_pages_v_blocks_content_section',
  {
    ...
    button_href: varchar('button_href'),
    button_icon:
      enum__pages_v_blocks_content_section_button_icon('button_icon').default('arrow-right'),
    _uuid: varchar('_uuid'),
    blockName: varchar('block_name'),
  },
  (columns) => ({
    _orderIdx: index('_pages_v_blocks_content_section_order_idx').on(columns._order),
    _parentIDIdx: index('_pages_v_blocks_content_section_parent_id_idx').on(columns._parentID),
    _pathIdx: index('_pages_v_blocks_content_section_path_idx').on(columns._path),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [_pages_v.id],
      name: '_pages_v_blocks_content_section_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const haut_de_page_nav_items_sub_navigation = pgTable(
  'haut_de_page_nav_items_sub_navigation',
  {
    _order: integer('_order').notNull(),
    _parentID: varchar('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type:
      enum_haut_de_page_nav_items_sub_navigation_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    link_label: varchar('link_label').notNull(),
  },
  (columns) => ({
    _orderIdx: index('haut_de_page_nav_items_sub_navigation_order_idx').on(columns._order),
    _parentIDIdx: index('haut_de_page_nav_items_sub_navigation_parent_id_idx').on(
      columns._parentID,
    ),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [haut_de_page_nav_items.id],
      name: 'haut_de_page_nav_items_sub_navigation_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const haut_de_page_nav_items = pgTable(
  'haut_de_page_nav_items',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    id: varchar('id').primaryKey(),
    link_type: enum_haut_de_page_nav_items_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    link_label: varchar('link_label').notNull(),
  },
  (columns) => ({
    _orderIdx: index('haut_de_page_nav_items_order_idx').on(columns._order),
    _parentIDIdx: index('haut_de_page_nav_items_parent_id_idx').on(columns._parentID),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [haut_de_page.id],
      name: 'haut_de_page_nav_items_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const haut_de_page = pgTable('haut_de_page', {
  id: serial('id').primaryKey(),
  updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 }),
  createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 }),
})

export const haut_de_page_rels = pgTable(
  'haut_de_page_rels',
  {
    id: serial('id').primaryKey(),
    order: integer('order'),
  ...
  (columns) => ({
    order: index('haut_de_page_rels_order_idx').on(columns.order),
    parentIdx: index('haut_de_page_rels_parent_idx').on(columns.parent),
    pathIdx: index('haut_de_page_rels_path_idx').on(columns.path),
    haut_de_page_rels_pages_id_idx: index('haut_de_page_rels_pages_id_idx').on(columns.pagesID),
    haut_de_page_rels_posts_id_idx: index('haut_de_page_rels_posts_id_idx').on(columns.postsID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [haut_de_page.id],
      name: 'haut_de_page_rels_parent_fk',
    }).onDelete('cascade'),
    pagesIdFk: foreignKey({
      columns: [columns['pagesID']],
      foreignColumns: [pages.id],
      name: 'haut_de_page_rels_pages_fk',
    }).onDelete('cascade'),
    postsIdFk: foreignKey({
      columns: [columns['postsID']],
      foreignColumns: [posts.id],
      name: 'haut_de_page_rels_posts_fk',
    }).onDelete('cascade'),
  }),
)
...
export const relations_pages_blocks_content_section_images = relations(
  pages_blocks_content_section_images,
  ({ one }) => ({
    _parentID: one(pages_blocks_content_section, {
      fields: [pages_blocks_content_section_images._parentID],
      references: [pages_blocks_content_section.id],
      relationName: 'images',
    }),
    image: one(media, {
      fields: [pages_blocks_content_section_images.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations_pages_blocks_content_section = relations(
  pages_blocks_content_section,
  ({ one, many }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_content_section._parentID],
      references: [pages.id],
      relationName: '_blocks_contentSection',
    }),
    images: many(pages_blocks_content_section_images, {
      relationName: 'images',
    }),
  }),
)
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  _blocks_contentSection: many(pages_blocks_content_section, {
    relationName: '_blocks_contentSection',
  }),
...
export const relations__pages_v_blocks_content_section_images = relations(
  _pages_v_blocks_content_section_images,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_content_section, {
      fields: [_pages_v_blocks_content_section_images._parentID],
      references: [_pages_v_blocks_content_section.id],
      relationName: 'images',
    }),
    image: one(media, {
      fields: [_pages_v_blocks_content_section_images.image],
      references: [media.id],
      relationName: 'image',
    }),
  }),
)
export const relations__pages_v_blocks_content_section = relations(
  _pages_v_blocks_content_section,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_content_section._parentID],
      references: [_pages_v.id],
      relationName: '_blocks_contentSection',
    }),
    images: many(_pages_v_blocks_content_section_images, {
      relationName: 'images',
    }),
  }),
)
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  _blocks_contentSection: many(_pages_v_blocks_content_section, {
    relationName: '_blocks_contentSection',
  }),
...
export const relations_haut_de_page_nav_items_sub_navigation = relations(
  haut_de_page_nav_items_sub_navigation,
  ({ one }) => ({
    _parentID: one(haut_de_page_nav_items, {
      fields: [haut_de_page_nav_items_sub_navigation._parentID],
      references: [haut_de_page_nav_items.id],
      relationName: 'subNavigation',
    }),
  }),
)
export const relations_haut_de_page_nav_items = relations(
  haut_de_page_nav_items,
  ({ one, many }) => ({
    _parentID: one(haut_de_page, {
      fields: [haut_de_page_nav_items._parentID],
      references: [haut_de_page.id],
      relationName: 'navItems',
    }),
    subNavigation: many(haut_de_page_nav_items_sub_navigation, {
      relationName: 'subNavigation',
    }),
  }),
)
export const relations_haut_de_page_rels = relations(haut_de_page_rels, ({ one }) => ({
  parent: one(haut_de_page, {
    fields: [haut_de_page_rels.parent],
    references: [haut_de_page.id],
    relationName: '_rels',
  }),
  pagesID: one(pages, {
    fields: [haut_de_page_rels.pagesID],
    references: [pages.id],
    relationName: 'pages',
  }),
  postsID: one(posts, {
    fields: [haut_de_page_rels.postsID],
    references: [posts.id],
    relationName: 'posts',
  }),
}))
export const relations_haut_de_page = relations(haut_de_page, ({ many }) => ({
  navItems: many(haut_de_page_nav_items, {
    relationName: 'navItems',
  }),
  _rels: many(haut_de_page_rels, {
    relationName: '_rels',
  }),
}))
...
type DatabaseSchema = {
  ...
  enum_pages_blocks_content_section_button_icon: typeof enum_pages_blocks_content_section_button_icon
  ...
  enum__pages_v_blocks_content_section_button_icon: typeof enum__pages_v_blocks_content_section_button_icon
  ...
  enum_haut_de_page_nav_items_sub_navigation_link_type: typeof enum_haut_de_page_nav_items_sub_navigation_link_type
  enum_haut_de_page_nav_items_link_type: typeof enum_haut_de_page_nav_items_link_type
  ...
  pages_blocks_content_section_images: typeof pages_blocks_content_section_images
  pages_blocks_content_section: typeof pages_blocks_content_section
  pages: typeof pages
  ...
  _pages_v_blocks_content_section_images: typeof _pages_v_blocks_content_section_images
  _pages_v_blocks_content_section: typeof _pages_v_blocks_content_section
  ...
  haut_de_page_nav_items_sub_navigation: typeof haut_de_page_nav_items_sub_navigation
  haut_de_page_nav_items: typeof haut_de_page_nav_items
  haut_de_page: typeof haut_de_page
  haut_de_page_rels: typeof haut_de_page_rels
  ...
  relations_pages_blocks_content_section_images: typeof relations_pages_blocks_content_section_images
  relations_pages_blocks_content_section: typeof relations_pages_blocks_content_section
  ...
  relations__pages_v_blocks_content_section_images: typeof relations__pages_v_blocks_content_section_images
  relations__pages_v_blocks_content_section: typeof relations__pages_v_blocks_content_section
  ...
  relations_haut_de_page_nav_items_sub_navigation: typeof relations_haut_de_page_nav_items_sub_navigation
  relations_haut_de_page_nav_items: typeof relations_haut_de_page_nav_items
  relations_haut_de_page_rels: typeof relations_haut_de_page_rels
  relations_haut_de_page: typeof relations_haut_de_page
